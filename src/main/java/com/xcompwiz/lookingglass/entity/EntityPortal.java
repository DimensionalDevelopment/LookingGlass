...
public class EntityPortal extends Entity {
	...
	private DataParameter<Integer> targetID	= new DataParameter<>(20, DataSerializers.VARINT);
	...
	public EntityPortal(World world) {
		super(world);
		getDataManager().register(targetID, 0);
	}
	...
	private void setTarget(int targetdim) {
		getDataManager().set(targetID, targetdim);
	...
	private int getTarget() {
		return getDataManager().get(targetID);
	}

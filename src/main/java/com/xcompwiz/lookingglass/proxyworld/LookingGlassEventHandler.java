...
public class LookingGlassEventHandler {
    ...
    public void onClientTick(TickEvent.ClientTickEvent event) {
        ...
        if (++tickcounter % 200 == 0) ProxyWorldManager.detectFreedWorldViews();
        ...
        if (mc.world != previousWorld) {
            ...
            if (previousWorld != null)
                previousWorld.removeAllEntities(); //TODO: This is hardly an ideal solution (It also doesn't seem to work well)
    ...
    @SideOnly(Side.CLIENT)
    @SubscribeEvent
    public void onRenderTick(TickEvent.RenderTickEvent event) { // TODO: profiling
        // If no client world we're not playing. Abort.

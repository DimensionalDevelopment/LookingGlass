...
public class SubChunkUtils {
    public static boolean withinDistance(ChunkCoordinates c1, int x, int y, int z, int distance) {
    ...
    public static boolean withinRange(ChunkCoordinates c1, int x, int y, int z, int d1, int d2) {
